...
if( empty( $_SESSION['id_user'] ) ){
	...
	die();
      ...
      if(isset($_REQUEST['submit'])){
		 ...
		 echo '<h2 style="color: #ffffff;">Rekap Laporan Penghasilan <small style="color: #FFFF00;">'.$tgl1.' sampai '.$tgl2.'</small></h2><hr>
	 ...
	 echo '
		...
		<div class="col-sm-6"><table class="table table-bordered">';
		 ...
		 list($nama, $total) = mysqli_fetch_array($sql);{
			echo '<tr><td><span class="pull-right"><h4 style="color: #ffffff;"><b>'.$nama.' Orang</b></h4></span></td><td><span class="pull-right"><h4 style="color: #ffffff;"><b>RP. '.number_format($total).'</b></h4></span></td></tr>';
		...
		echo '<h2 style="color: #ffffff;">Rekap Laporan Penghasilan Hari Ini (<small style="color: #ffffff;">'.date('d-m-Y').'</small>)</h2><hr>';
